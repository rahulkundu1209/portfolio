...
import {faEnvelope, faHome, faUser, faRectangleList, faComments, faGlobe, faCircleChevronDown} from '@fortawesome/free-solid-svg-icons';
    ...
    <nav className='nav-bar'>
        ...
        <div className="desktop-menu-horizontal" onClick={()=>setShowMenu(false)}>
          ...
          <div className={`${showMenu===true ? "dropdown dropdown-go-below" : "dropdown"}`}>
            <img src={dropDownIcon} className='dropdown-icon' onClick={showMenuHandler}/>
          </div>
          <div className={`${showMenu===true ? "desktop-menu-vertical desktop-menu-vertical-mob-view" : "desktop-menu-vertical"}`} onClick={()=>setShowMenu(false)}>
